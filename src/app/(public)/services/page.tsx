            ...
            <Tabs defaultValue="screening" className="w-full md:w-146">
                ...
                {content.map((item) => (
                    ...
                    >
                        ...
                        <div className="border-primary absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 rounded-2xl border-3 bg-white p-3">
                            {item.title}
                        </div>
                        ...
                        <DecorImage
                            ...
                            alt="Decor Highlight"
                            size={[80, 80]}
                            className="right-0 bottom-0 z-10 translate-y-1/6"
                        />
                    </TabsContent>
                ))}
            </Tabs>
...
function ConsultationSection() {
    return (
        <section className="section relative flex h-full grow flex-col items-center justify-center gap-6 py-8 md:gap-12">
            ...
            <div className="grid w-full grid-cols-1 md:grid-cols-[40fr_60fr] md:gap-12">
                <div className="relative mr-8 mb-16 aspect-49/50 w-full">
                    ...
                    <DecorImage
                        ...
                        alt="Decor Butterfly"
                        size={[160, 160]}
                        className="right-0 bottom-0 z-10 -translate-x-1/8 translate-y-1/2 stroke-3"
                    />
                </div>
...
function ConsultationSection1() {
    return (
        <section className="section relative flex h-full grow flex-col items-center justify-center gap-6 py-8 md:gap-12">
            ...
            <div className="grid w-full grid-cols-1 md:grid-cols-[60fr_40fr] md:gap-12">
                <div className="relative order-last mr-8 mb-16 aspect-49/50 w-full">
                    <Image
                        src="/images/services-bg-1.jpg"
                        fill
                        sizes="100vw"
